...
botonAdicionar.addEventListener("click",function(event){
	...
	function construirTd(dato,clase){
		...
		var td = document.createElement('td'); //crear un objeto td
		td.classList.add(clase); // a ese objeto le creo una clase con classlist, cuyo parametro es la clase que estoy recibiendo
		td.textContent = dato;
